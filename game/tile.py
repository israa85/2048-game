...
class Tile:
    ...
    def draw(self, window, font, font_4digit):
        ...
        # Use smaller font for 4-digit numbers (>=1000)
        chosen_font = font_4digit if self.value >= 1000 else font
        text = chosen_font.render(str(self.value), True, text_color)
        window.blit(
            text,
            (
